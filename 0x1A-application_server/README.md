...
```
> The issue was the number of file the user `holberton` was allowed to open from as you notice from my terminal i opened the file `/etc/security/limits.conf` to increase the size and that was how iwas able to solve it.  0,0-1         All

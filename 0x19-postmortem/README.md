...
Upon the release of ALX's System Engineering & DevOps project 0x19, approximately 06:00 Central African Time (CAT) here in South Africa, an outage occurred on an isolated Ubuntu 14.04 container running an Apache web server. GET requests on the server led to 500 Internal Server Error's, when the expected response was an HTML file defining a simple Holberton WordPress site.

## Debugging Process

Debugger Edward encountered the issue upon opening the project and being, well, instructed to
...
In full, the WordPress app was encountering a critical
...
[0-strace_is_your_friend.pp](https://github.com/EdwardM1276/alx-system_engineering-devops/blob/main/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
